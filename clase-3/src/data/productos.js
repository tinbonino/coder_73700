...
export const productos = [
    ...
    { id: 7, nombre: "Queso cheddar", precio: 4.0, descripcion: "Queso madurado de sabor fuerte y textura suave.", categoria: "Frutas y Verduras" },
    { id: 8, nombre: "Pollo", precio: 5.5, descripcion: "Carne de pollo fresca, ideal para cocinar a la parrilla.", categoria: "Lácteos" },
    { id: 9, nombre: "Zanahorias", precio: 0.9, descripcion: "Verduras frescas y crujientes, ricas en betacarotenos.", categoria: "Panadería y Cereales" },
    { id: 10, nombre: "Pasta integral", precio: 2.0, descripcion: "Pasta elaborada con harina de trigo integral.", categoria: "Frutas y Verduras" }
  ];